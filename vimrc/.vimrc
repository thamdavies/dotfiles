...
" Join lines (J) without moving the cursor position
nnoremap J mzJ`z

" Keep cursor centered vertically while scrolling half-pages
nnoremap <C-d> <C-d>zz
nnoremap <C-u> <C-u>zz

" Keep search results centered and expand folds automatically
nnoremap n nzzzv
nnoremap N Nzzzv
...
" (Sends the replaced text to the 'black hole' register)
xnoremap <leader>p "_dP

" Yank (copy) text directly to the system clipboard
nnoremap <leader>y "+y
vnoremap <leader>y "+y
nnoremap <leader>Y "+Y

" Delete text to the 'black hole' register (does not overwrite clipboard)
...
" Move the currently selected lines DOWN in visual mode
function! MoveLinesDownVisual()
  let l:current_line = line('.')
  let l:last_line = line('$')
  let l:selected_lines_count = line("'>") - line("'<")

  if l:current_line + l:selected_lines_count < l:last_line
    execute "'<,'>m '>+1"
    normal! gv=gv
  else
    normal! gv
...
" Move the currently selected lines UP in visual mode
function! MoveLinesUpVisual()
  let l:current_line = line('.')
